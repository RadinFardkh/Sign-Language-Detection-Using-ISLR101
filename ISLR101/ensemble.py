...
label = np.load('/home/hranjb/data/islr101_test_label.npy')
#
r1 = open('/home/hranjb/data/ST-TR/experiments/test_ttr/epoch1_test_score.pkl', 'rb')
r1 = list(pickle.load(r1).items())
r2 = open('/home/hranjb/data/ST-TR/experiments/test_str/epoch1_test_score.pkl', 'rb')
